...
- [ ] T034 [US1] Implement C64 keyboard matrix (8x8 matrix state) in src/c64/keyboard.rs
...
- [ ] T043 [P] [US1] Create HTML structure with canvas element (320x200) in c64-demo/index.html
- [ ] T044 [P] [US1] Create C64-themed CSS styling (blue background, border) in c64-demo/style.css
...
- [ ] T067 [US3] Implement multicolor text mode (MCM bit, 160x200 effective) in src/devices/c64/vic_ii.rs
...
- [ ] T071 [US3] Implement sprite data fetching (pointer at Screen+$3F8) in src/devices/c64/vic_ii.rs
- [ ] T072 [US3] Implement sprite rendering (8 sprites, 24x21 pixels) in src/devices/c64/vic_ii.rs
- [ ] T073 [US3] Implement sprite multicolor mode (12x21 pixels, 4 colors) in src/devices/c64/vic_ii.rs
- [ ] T074 [US3] Implement sprite X/Y expansion (double size) in src/devices/c64/vic_ii.rs
- [ ] T075 [US3] Implement sprite priority (sprite-to-sprite, sprite-to-background) in src/devices/c64/vic_ii.rs
- [ ] T076 [US3] Implement sprite collision detection (registers $1E, $1F) in src/devices/c64/vic_ii.rs

### SID Audio Generation

- [ ] T077 [US3] Implement 24-bit phase accumulator per voice in src/devices/c64/sid.rs
- [ ] T078 [US3] Implement waveform generation (triangle, sawtooth, pulse, noise) in src/devices/c64/sid.rs
